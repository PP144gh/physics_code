...
int main() {
 ...
 ofstream myfile;
  myfile.open ("hist_data.txt");
   for (int i=0; i<tries; ++i) {


  //pop generator
  int cellnumber=10; //has to be even
  int cellnumberinit=cellnumber;
  //pop A
  ...
  //conditions
  int maxage=10; //after maxage steps cells die
  int maxswof=5; //max steps without food
  int x; int y; //position variables
  int dmax=50; //max steps of simulation
  int minagesex=1; //min age for reproduction
